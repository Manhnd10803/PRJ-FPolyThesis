...
// img
import error500 from '@/assets/images/page/500.png';
        ...
        <Row className="no-gutters height-self-center">
          <Col sm="12" className="text-center align-self-center">
            <div className="iq-error position-relative mt-5">
              ...
              <h2 className="mb-0 text-center">Rất tiếc! Trang này không hoạt động.</h2>
              <p className="text-center">Có sự cố trên máy chủ.</p>
