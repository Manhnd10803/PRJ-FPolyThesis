...
import { Col, Container, Dropdown, Modal, OverlayTrigger, Row, Tooltip } from 'react-bootstrap';
                    ...
                    <Modal.Body>
                      ...
                      <ul className="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                        ...
                        <li className="col-md-6 mb-3">
                          <div className="bg-soft-primary rounded p-2 pointer me-3">
                            <Link to="#"></Link>
                            <img src={imageUrl} alt="icon" className="img-fluid" /> Live Video
                          </div>
                        </li>
                        <li className="col-md-6 mb-3">
                          <div className="bg-soft-primary rounded p-2 pointer me-3">
                            <Link to="#"></Link>
                            <img src={imageUrl} alt="icon" className="img-fluid" /> Gif
                          </div>
                        </li>
                        <li className="col-md-6 mb-3">
                          <div className="bg-soft-primary rounded p-2 pointer me-3">
                            <Link to="#"></Link>
                            <img src={imageUrl} alt="icon" className="img-fluid" /> Watch Party
                          </div>
                        </li>
                        <li className="col-md-6 mb-3">
                          <div className="bg-soft-primary rounded p-2 pointer me-3">
                            <Link to="#"></Link>
                            <img src={imageUrl} alt="icon" className="img-fluid" /> Play with Friends
                          </div>
                        </li>
                      </ul>
                      <hr />
