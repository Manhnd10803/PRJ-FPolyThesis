...
export const Direction = memo((props: DirectionProps) => {
  return (
    <>
      ...
      <RadioBtn
        ...
        labelclassName="form-check-label h6 d-flex align-items-center justify-content-between"
      ...
      >
        ...
        <svg width="60" height="27" viewBox="0 0 60 27" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect
            ...
            height="3.2"
            rx="1.6"
            transform="matrix(-1 0 0 1 39 16.1003)"
            fill="#80868B"
          ></rect>
          <rect
            x="-0.375"
