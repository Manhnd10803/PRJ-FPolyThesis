...
import { Direction, MenuActiveStyle, MenuStyle, ColorCustomizer, ThemeScheme } from './sections';

type SettingOffCanvasProps = {
  name?: boolean;
};

export const SettingOffCanvas = memo((props: SettingOffCanvasProps) => {
  ...
  return (
    <Fragment>
      <div
        className="bg-primary text-white btn btn-fixed-end btn-icon btn-setting"
        onClick={e => {
          e.stopPropagation();
          setShow(true);
        }}
