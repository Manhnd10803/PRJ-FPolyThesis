    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-lg-12" style="background-color:white; boder-radius:10px;">
              <div class="card-block card-stretch card-height qa qa-detail" style="margin: 25px">
                  <div class="card-body">
                      <div class="qa-description mt-3">
                          <div class="d-flex align-items-center justify-content-between" style="display:flex; align-item: center; justify-content:space-between;">
                              <div class="d-flex align-items-center" style="display:flex; align-item: center; ">
                                  <div class="user-image mb-3"  style="margin-right:25px ">
                                      <img class="avatar-80 rounded" height="80px" width="80px"  style="border-radius: 50%" src="{{ $qa->user->avatar }}" alt="Ảnh đại diện">
                                  </div>
                                  <div class="ms-3" style="margin-left: 1rem; ">
                                      {{-- <a href="{{ route('profile', ['id' => $data['qa']['user']['id']]) }}"> --}}
                          ...
                          <div class="qa-meta d-flex align-items-center gap-4 mb-3 position-right-side flex-wrap">
                          ...
                          <h2 class="mb-3 pb-3 border-bottom" style="margin-bottom: 1rem; padding-bottom: 1rem; border-bottom: 1px solid #dee2e6;">{{ $qa->title }}</h2>
                          <p>{!! $qa->content ? json_decode($qa->content) : '' !!}</p>
                      </div>
