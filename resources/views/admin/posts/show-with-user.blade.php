    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-lg-12" style="background-color:white; boder-radius:10px;">
              <div class="card-block card-stretch card-height post post-detail" style="margin: 25px">
                  <div class="card-body">
                        <div class="post-description mt-3">
                            <div class="d-flex align-items-center justify-content-between" style="display:flex; align-item: center; justify-content:space-between;">
                                <div class="d-flex align-items-center" style="display:flex; align-item: center; ">
                                    <div class="user-image mb-3"  style="margin-right:25px ">
                                        <img class="avatar-80 rounded" height="80px" width="80px"  style="border-radius: 50%" src="{{ $post->user->avatar }}" alt="Ảnh đại diện">
                                    </div>
                                    <div class="ms-3" style="margin-left: 1rem; ">
                                      {{-- <a href="{{ route('profile', ['id' => $data['post']['user']['id']]) }}"> --}}
                                          <div class="d-flex gap-2 align-items-center" style="display:flex; align-item: center; ">
                                              ...
                                              {{-- <div class="d-flex gap-1 align-items-center" style="display:flex; align-item: center; ">
                                                  ...
                                                  <div>{{ $post->user->score }}</div>
                                              </div> --}}
                                          </div>
                                          {{-- <p class="text-black">
                                            @if ($post->major && $post->major->majors_name)
                                                {{ $post->major->majors_name }}
                                            @else
                                            @endif
                                          </p> --}}
                                      {{-- </a> --}}
                          ...
                          <div class="post-meta d-flex align-items-center gap-4 mb-3 position-right-side flex-wrap">
                          ...
                          <h2 class="mb-3 pb-3 border-bottom" style="margin-bottom: 1rem; padding-bottom: 1rem; border-bottom: 1px solid #dee2e6; font-weight:bold;">{{ $post->title }}</h2>
                          {{-- <p>{!! $post->content ? json_decode($post->content) : '' !!}</p> --}}
                          <p>{{ $post->content }}</p>
                        </div>
